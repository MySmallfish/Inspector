        ...
        function ($q, $rootScope, storageService, utils, geoLocation, siteService, employeeService, inspectorApi, loginManager, $log) {
            ...
            function reportTime(reportInfo) {
                ...
                function onTimeReportDataReady(results) {
                    ...
                    if (!employeeInfo) {
                        ...
                        error = "SiteMissing";
                    } else if (!locationInfo && reportInfo.requiresLocation) {
                ...
                var promise = $q.all([
                        ...
                        getLocation(reportInfo.requiresLocation),
            ...
            function getLocation(isMandatory) {
                ...
                setTimeout(function () {
                    if (!timedout && !resolved) {
                        timedout = true;
                        onError({ error: "LocationNotFound" });
                    }
                }, 10000);
            ...
            function reportByCode(barCode, isEnter) {
                ...
                function getEmployee(user) {
                    return { user: user, employee: { Id: user.EmployeeId } };
                }

                function prepareReport(userEmployee) {
                    var report = {
                        barCode: barCode,
                        isEnter: isEnter,
                        employee: userEmployee.employee,
                        requiresLocation: userEmployee.user.RequiresLocation,
                        siteId: barCode
                    };
                    return report;
                }
