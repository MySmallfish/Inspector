(function (S, I) {
    ...
    simplyLogModule.run(function (textResource) {
        textResource.load("he-IL", {
            ...
            "CommunicationError": "לא ניתן לקיים תקשורת עם השרת, בדוק חיבור רשת ונסה שנית.",
            "AuthenticationFailed": "שם המשתמש או הסיסמה שגויים",
            "InvalidPhoneNumber":"הדיווח למכשיר זה נעול על משתמש אחר. הניסיון נרשם במערכת.",
            "EnterPassword": "סיסמה",
