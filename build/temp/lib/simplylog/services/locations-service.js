(function (S, SL) {
    ...
    SL.LocationsService = ["$q", "queueManager", "$http", "configurationManager", "$cacheFactory", "entityManager", function ($q, queueManager, $http, configurationManager, $cacheFactory, entityManager) {
