(function (S, SL) {
    SL.Database = [
        "dataBaseProvider", function (dataBaseProvider) {
                ...
                Tables: [
                    {
                        ...
                        Columns: [
                            ...
                            { Name: "DefaultCategoryId", Type: S.DbType.Int },
                            { Name: "DefaultCategoryName", Type: S.DbType.Text },
                            { Name: "DefaultCategoryPath", Type: S.DbType.Text },
                            { Name: "EventSeverityId", Type: S.DbType.Int },
                            { Name: "EventSeverityName", Type: S.DbType.Text },
                            { Name: "EventSeverityColor", Type: S.DbType.Int },
                            { Name: "CategoryDefaultDescription", Type: S.DbType.Text },
                            { Name: "CategoryId", Type: S.DbType.Int },
                            { Name: "CategoryName", Type: S.DbType.Text },
                            { Name: "CategoryPath", Type: S.DbType.Text }
                        ]
                    },
                {
                    Name: "Attachments",
                    Columns: [
                        { Name: "Id", Type: S.DbType.Int, Nullable: false, IsPrimary: true },
                        { Name: "Updated", Type: S.DbType.DateTime },
                        { Name: "Url", Type: S.DbType.Text },
                        { Name: "Name", Type: S.DbType.Text },
                        { Name: "Title", Type: S.DbType.Text },
                        { Name: "ContentType", Type: S.DbType.Text },
                        { Name: "EntityName", Type: S.DbType.Text },
                        { Name: "EntityId", Type: S.DbType.Int }
                    ]
                },
                    {
                        Name: "Equipments",
                    ...
                    },
                    {
                        ...
                        Columns: [
                            ...
                            { Name: "FirstName", Type: S.DbType.Text },
                            { Name: "LastName", Type: S.DbType.Text },
                            { Name: "Address", Type: S.DbType.Text },
                            { Name: "City", Type: S.DbType.Text },
                            { Name: "ContactTypeId", Type: S.DbType.Int },
                            { Name: "Email", Type: S.DbType.Text },
                            { Name: "Phone1", Type: S.DbType.Text },
                            { Name: "Mobile", Type: S.DbType.Text },
                            { Name: "LocationEntityId", Type: S.DbType.Text },
                            { Name: "LocationEntityType", Type: S.DbType.Text },
                            { Name: "LocationPath", Type: S.DbType.Text },
                            { Name: "LocationFullName", Type: S.DbType.Text },
                            { Name: "DutyId", Type: S.DbType.Int },
                            { Name: "DutyName", Type: S.DbType.Text },
                            { Name: "DepartmentId", Type: S.DbType.Int },
                            { Name: "DepartmentName", Type: S.DbType.Text },
                            { Name: "CertificateNumber", Type: S.DbType.Text },
                            { Name: "ImageUrl", Type: S.DbType.Text },
                            { Name: "Remarks", Type: S.DbType.Text }
                        ]
                    },
                    {
            ...
            return {
                $get: [
                    "dataBase", "loginManager", function (dataBase, loginManager) {
                        return {
                            get: function () {
                                return loginManager.isUserLoggedIn().then(function (user) {
                                    return dataBase("Simple.SimplyLog", user.user.Username);
                                });
                            }
                        };
                    }
